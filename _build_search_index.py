...
def categorize(rel_path: str, title: str) -> tuple:
    ...
    page_map = {
        ...
        "berkshire-ai-chain-阿里.html": ("AI产业链", 40),
        "berkshire-ai-chain-腾讯.html": ("AI产业链", 40),
        "berkshire-ai-chain-字节.html": ("AI产业链", 40),
        "berkshire-ai-chain-华为.html": ("AI产业链", 40),
        "berkshire-ai-chain-百度.html": ("AI产业链", 40),
