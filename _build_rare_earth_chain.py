...
<li><b>份额</b>：CR 提升、高端化 → 均价与利润上行，弱化行业周期。</li>
    ...
    'rare-earth': {
        'criteria': '''<p><b>驱动变量</b>：稀土价格（轻稀土镨钕 / 中重稀土镝铽）、国家总量控制配额（开采 + 冶炼分离指标）、下游新能源 / 风电 / 机器人磁材需求、海外矿供应与政策、走私与替代材料。</p>
<ul>
...
<li><b>政策</b>：集团专业化整合（中国稀土集团）优化供给格局，战略地位提升。</li>
        ...
        'current': '稀土呈"资源战略化 + 配额约束 + 磁材驱动"：轻稀土看镨钕（新能源磁材），中重稀土看镝铽（战略属性），总量控制配额是供给根本约束；当前磁材需求（风电 / 电车 / 机器人）提供长期拉动，价格周期与配额政策是核心变量。'
    },
}
...
# ============ 数据 ============
from _rare_earth_data import rare_earth
